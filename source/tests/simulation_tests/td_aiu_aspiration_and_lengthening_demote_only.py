...
constraint_set_file_name = "aspiration_and_lengthening_demote_only_constraint_set.json"
log_file_template = "{}_td_aiu_aspiration_and_lengthening_200_demote_only_{}.txt"
